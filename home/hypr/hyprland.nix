...
bind = $mainMod, S, exec, env QT_QPA_PLATFORM_PLUGIN_PATH="/home/psiri/Documents/github/psiri/nixos-config/pkgs/securecrt/result/usr/lib/scrt-sfx/plugins/platforms/" ~/Documents/github/psiri/nixos-config/pkgs/securecrt/result/usr/bin/SecureCRT
