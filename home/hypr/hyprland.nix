...
# Window Rules
windowrulev2 = opacity 1.0 1.0 override,class:chromium-browser,title:(.*)( - YouTube)$  # Disables opacity of any YouTube windows
windowrulev2 = nodim,class:chromium-browser,title:(.*)( - YouTube)$                     # Disables dimming of any YouTube windows
