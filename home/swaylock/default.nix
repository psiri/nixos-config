{
  ...
  home-manager.users.${user} = {
    ...
    home.file.".config/hypr/per-app/swaylock.conf" = {
      text = ''
        bind = $mainMod, L, exec, grim ~/.cache/lockscreen.png; sleep 1; convert ~/.cache/lockscreen.png -blur 0x6 ~/.cache/lockscreen.png; sleep 1; swaylock --image ~/.cache/lockscreen.png 
      '';
