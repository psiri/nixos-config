...
# Use this to configure your system environment (it replaces /etc/nixos/configuration.nix)
{
  ...
  environment = {
    ...
    sessionVariables = rec
    {
      ...
      GIO_EXTRA_MODULES="${pkgs.gvfs}/lib/gio/modules:${pkgs.dconf.lib}/lib/gio/modules"; # Fix to get file managers to be able to mount SMB / CIFS / NFS and trash locations
    };
